...
{{-- Card --}}
    ...
    <div class="pt-4 pb-8 px-32">
        <div class="flex flex-col items-center p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
            <a> <h5 class="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white font-Cabin-Medium">Vegetarian Lasagne</h5> </a>

            <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
                <div class="grid gap-4">
                    <a> <h5 class="mb-2 text-xl font-regular tracking-tight text-gray-400 dark:text-white font-Cabin-Medium">Person : 4</h5> </a>
                </div>
                <div class="grid gap-4">
                    <a> <h5 class="mb-2 text-xl font-regular tracking-tight text-gray-400 dark:text-white font-Cabin-Medium">Time : 40m</h5> </a>
                </div>
            </div>
            ...
            {{-- Grid --}}
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4 pt-8">
                    <div class="grid gap-4 col-span-2 ">
                        {{-- Foto --}}
                        <div class="flex flex-col items-center">
                                {{-- <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image.jpg" alt=""> --}}
                                <img class="h-[500px] rounded-lg " src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image.jpg" alt="">
                        </div>
                        {{-- Share Button --}}
                        <div>
                                <!-- Modal toggle -->
                                <div class="flex justify-center m-5">
                                    <button id="successButton" data-modal-toggle="successModal" type="button" class="inline-flex text-white bg-hijau1 hover:bg-hijau2 focus:ring-4 focus:outline-non focus:ring-hijau3 font-xl rounded-lg text-sm sm:w-auto px-[21px] py-2.5 text-center mx-auto font-Cabin-Medium" type="button">
                                        Bagikan Resep
                                        <svg aria-hidden="true" class="w-4 h-[20px] ml-2 -mr-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="grid gap-4 col-span-3">
                        {{-- Deskripsi --}}
                        <div>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Make our easy vegetarian lasagne using just a handful of ingredients. You can use ready-made tomato sauce and white sauce, or batch cook the sauces and freeze them</p>
                            <h1>Igredients</h1>
                            ...
                            <h1>Steps</h1>
                            <ul class="list-disc pl-5">
                                <li >To make the tomato sauce, heat the olive oil in a saucepan. Add the onions, garlic and carrot.
                                    Cook for 5-7 mins over a medium heat until softened. Turn up the heat a little and stir in the tomato purée.
                                    ...
                                    Leave to cool then whizz in a food processor. Will keep, cooled, in the fridge for up to three days or frozen for three months.</li>
                                <li >To make the white sauce, melt the butter in a saucepan, stir in the plain flour, then cook for 2 mins.
                                    Slowly whisk in the milk, then bring to the boil, stirring. Turn down the heat, then cook until the sauce starts to thicken and coats the back of a wooden spoon.
                                    Will keep, cooled, in the fridge for up to three days or frozen for three months.</li>
                                <li>Heat the oven to 200C/180C fan/gas 6. Lightly oil two large baking trays and add the peppers and aubergines.
                                    Toss with the olive oil, season well, then roast for 25 mins until lightly browned.</li>
                                <li>Reduce the oven to 180C/160C fan/gas 4. Lightly oil a 30 x 20cm ovenproof dish. Arrange a layer of the vegetables on the bottom, then pour over a third of the tomato sauce.
                                    Top with a layer of lasagne sheets, then drizzle over a quarter of the white sauce. Repeat until you have three layers of pasta.</li>
                                <li>Spoon the remaining white sauce over the pasta, making sure the whole surface is covered, then scatter over the mozzarella and cherry tomatoes.
                                    Bake for 45 mins until bubbling and golden.</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            {{-- End Grid --}}
            <p class="pt-8 mb-3 font-normal text-gray-400 dark:text-slate-100">Author : Admin1</p>
        </div>
    </div>
...
<div id="successModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        {{-- Footer --}}
        <footer class="bg-hijau4 dark:bg-gray-100 pb-10">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="grid grid-cols-2 gap-16 sm:gap-12 sm:grid-cols-3">
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-100 uppercase dark:text-white">Makanan</h2>
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-100 uppercase dark:text-white">Informasi</h2>
                        <ul class="text-gray-100 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="{{ url('/about') }}" class="hover:underline">Tentang Kami</a>
                            </li>
                            <li>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-50 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">FoodRescue</a>. All Rights Reserved.
                </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="{{ url('/404') }}" class="text-gray-100 hover:text-gray-400 dark:hover:text-white">
