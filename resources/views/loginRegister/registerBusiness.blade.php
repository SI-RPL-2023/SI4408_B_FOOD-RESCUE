            ...
            <div class="px-8 pt-8 formLogin">
                <form action="{{ route('register.action') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="gap-8 columns-2">
                        ...
                        <div class="mb-2">
                            <label for="namaDepan" class="block mb-2 t text-gray-900 dark:text-white">Nama Depan</label>
                        ...
                        <div class="mb-2">
                            <label for="namaBelakang" class="block mb-2 t text-gray-900 dark:text-white">Nama Belakang</label>
                    ...
                    <div class="mb-2">
                        <label for="lokasi" class="block mb-2 t text-gray-900 dark:text-white">Lokasi Anda</label>
                    ...
                    <div class="mb-2">
                        <label for="nohp" class="block mb-2 t text-gray-900 dark:text-white">Nomor Hp</label>
                    ...
                    <div class="pt-4 flex flex-col items-center">
                        <button type="submit" class="text-white bg-hijau1 hover:bg-hijau2 focus:ring-4 focus:outline-non focus:ring- rounded-lg text-sm sm:w-auto px-40 py-2.5 text-center dark:bg-hijau1 dar:hover:bg-hijau1 dar:focus:ring-hijau1 mx-auto" value="buat akun" >Buat Akun</button>
                    </div>
                </form>
            </div>

            <p class="pt-8 text-center">Sudah Punya Akun? <strong><a class="hover:text-hijau1" href="{{ url('login') }}" class="text-reset text-heavy">Masuk Sekarang</a></strong></p>

            {{-- <a href="#" class="inline-flex items-center px-3 py-2 t text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Read more
