...
<body class="h-screen bg-no-repeat bg-cover bg-pattern">
    ...
    <div class=" pt-8 flex mx-auto place-content-center">
        <div class=" py-8 max-w-xl p-2 bg-white border border-gray-200 rounded-xl shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white ">Halooo..<br>Anda akan mendaftar sebagai Personal</h5>
            </a>
            ...
            <div class="px-8 pt-8 formLogin">
                <form  action="{{ route('register.action') }} " method="POST" enctype="multipart/form-data">
                    ...
                    <div class="pt-4 flex flex-col items-center">
                        <button type="submit" class=" text-white bg-hijau1 hover:bg-hijau2 focus:ring-4 focus:outline-non focus:ring-hijau3 font-medium rounded-lg text-md sm:w-auto px-40 py-2.5 text-center dark:bg-hijau1 dar:hover:bg-hijau1 dar:focus:ring-hijau1 mx-auto " value="buat akun">Buat Akun</button>
                    </div>
                </form>
            </div>
