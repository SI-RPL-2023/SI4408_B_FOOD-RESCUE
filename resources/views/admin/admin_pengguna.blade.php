    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="pt-4 space-y-[21px] font-medium">
            ...
            <li class="flex mx-auto place-content-center">
                <a href="{{ url('dashboard-pengguna') }}" class="flex items-center w-[278px] p-2 text-gray-900 rounded-lg bg-hijau1 ring-offset-2 focus:ring-2 focus:ring-hijau2 mr-3">
                    ...
                    <span class=" flex-1 ml-3 whitespace-nowrap text-abu font-bold text-[22px] font-Cabin-Medium">Daftar Pengguna</span>
                </a>
            </li>
            {{-- ======= End of Active State ======= --}}
            ...
            <div class="mx-auto overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-6 py-3 place-content-center text-center">Gambar Pengguna</th>
