        ...
        <div class="container mx-auto mb-10">
            <div class="grid gap-8 lg:grid-cols-2 ">
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="mb-5 font-cabin text-gray-500 dark:text-gray-400 line-clamp-3">{{ $blog->deskripsi }}</p>
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ url('detail-blog/' .$blog->id) }}" class="inline-flex items-center font-Cabin-medium text-primary-600 dark:text-primary-500 hover:underline">
                            Read more
