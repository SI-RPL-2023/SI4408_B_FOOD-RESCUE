        ...
        <div class="ml-1 mt-4 pb-4 mb-4 rounded-t">
            <form action="{{ route('update-blog', $blogs->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-6 flex flex-col items-center">
                    <button type="submit" class="text-white bg-hijau2 hover:bg-kuning2 focus:ring-4 focus:outline-none focus:ring-kuning2 font-cabin-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-kuning2 dark:hover:bg-kuning2 dark:focus:ring-blue-800">Edit</button>
                </div>
            </form>
        </div>
    </div>
