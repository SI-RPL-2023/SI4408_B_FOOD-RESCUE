...
{{-- Card --}}
    ...
    <div class="pt-4 pb-8 px-32">
        <div class="flex flex-col items-center p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
            <a> <h5 class="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white font-Cabin-Medium">{{ $resep->nama }}</h5> </a>

            <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
                <div class="grid gap-4">
                    <a> <h5 class="mb-2 text-xl font-regular tracking-tight text-gray-400 dark:text-white font-Cabin-Medium">{{ $resep->person }}</h5> </a>
                </div>
                <div class="grid gap-4">
            ...
            {{-- Grid --}}
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4 pt-8">
                    <div class="grid gap-4 col-span-2 max-h-[500px]">
                        {{-- Foto --}}
                        <div class="flex flex-col items-center ]">
                                <img class="h-[500px] rounded-lg " src="{{ asset('storage/photos/'.$resep->foto) }}" alt="{{ $resep->nama }}">
                        </div>
                        {{-- Share Button --}}
                        <div>
                                <!-- Modal toggle -->
                    ...
                    <div class="grid gap-4 col-span-3">
                        ...
                        <div>
                            ...
                            <p class="mb-3  text-lg text-gray-700 font-Cabin-Medium">{{ $resep->deskripsi }}</p>
                            <h1 class="pt-4 pb-0 font-bold text-2xl font-Cabin-Medium">Igredients</h1>
                            <ul class="list-disc pl-5">
                                @php
                                $ingredients = explode('- ', $resep->ingredients);
                                array_shift($ingredients);
                                @endphp
                                @foreach ($ingredients as $ingredient)
                                <li class="text-lg font-Cabin-Medium">{{ trim($ingredient) }}</li>
                                @endforeach
                            </ul>
                            <h1 class="pt-4 pb-0 font-bold text-2xl font-Cabin-Medium">Instructions</h1>
                            <ul class="list-decimal pl-5">
                                ...
                                @endphp
                                @foreach ($steps as $step)
                                <li class="text-lg ml-2 mb-4 font-Cabin-Medium">{{ trim($step) }}</li>
                                @endforeach
