      ...
      <form action="{{ route('donasi.action') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-6">
          ...
          <div class="mb-6">
            ...
            <input type="textarea" id="deskripsi" name="deskripsi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Deskripsi Singkat Makanan" required>
          </div>
          <div class="mb-6">
            <label for="lokasi" class="block mb-2 text-md font-bold text-gray-900 dark:text-white">Lokasi</label>
            <input type="lokasi" id="lokasi" name="lokasi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Detail Lokasi" required>
          </div>
        ...
        <div class="mb-6">
            ...
            <div class="relative max-w-sm">
                ...
                <input datepicker datepicker-format="yyyy-mm-dd" id="exp_date" name="exp_date" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pilih Tanggal">
            </div>
        ...
        <div class="mb-6">
            ...
            <label class="block mb-2 text-md font-bold text-gray-900 dark:text-white" for="foto">Upload file</label>
